...
Here's a blank template to get started: To avoid retyping too much info. Do a search and replace with your text editor for the following: `MohammadRokib`, `repo_name`, `twitter_handle`, `linkedin_username`, `email_client`, `email`, `project_title`, `project_description`
...
2. Clone the repo
  ...
  ```sh
  git clone https://github.com/MohammadRokib/repo_name.git
  ```
...
[issues-url]: https://github.com/MohammadRokib/repo_name/issues
